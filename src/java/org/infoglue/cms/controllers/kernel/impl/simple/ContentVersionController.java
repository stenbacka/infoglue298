...
public class ContentVersionController extends BaseController 
{
    ...
    */
    ...
    public ContentVersion create(Content content, Language language, ContentVersionVO contentVersionVO, Integer oldContentVersionId, boolean allowBrokenAssets, boolean duplicateAssets, Integer excludedAssetId, Database db) throws ConstraintException, SystemException, Exception
    {
    	...
    	contentVersionVO.setVersionValue(new VisualFormatter().stripInvalidXml(contentVersionVO.getVersionValue()));
...
//    	Timer t = new Timer();
        ...
        try
        {
        	updatedContentVersionVO = update(contentId, languageId, contentVersionVO, principal, db);
	    	commitTransaction(db);
        }
    ...
    public ContentVersionVO update(Integer contentId, Integer languageId, ContentVersionVO contentVersionVO, InfoGluePrincipal principal, Database db) throws Exception
    {
	...
	*/
	...
	public void updateAttributeValue(Integer contentVersionId, String attributeName, String attributeValue, InfoGluePrincipal infogluePrincipal) throws SystemException, Bug
	{
		...
		try
		{
			...
			updateAttributeValue(contentVersionId, attributeName, attributeValue, infogluePrincipal, db);
	...
	public void updateAttributeValue(Integer contentVersionId, String attributeName, String attributeValue, InfoGluePrincipal infogluePrincipal, Database db) throws SystemException, Bug
	{
		...
		if(contentVersionVO != null)
		{
			try
			{
				...
				update(contentVersionVO.getContentId(), contentVersionVO.getLanguageId(), contentVersionVO, infogluePrincipal, db);
			}
			catch(Exception e)
			{
				e.printStackTrace();
