...
public class ViewManagementToolToolBarAction extends InfoGlueAbstractAction
{
	...
	{
		List buttons = new ArrayList();
		buttons.add(new ImageButton("DeleteRepository!input.action?repositoryId=" + this.repositoryId, getLocalizedString(getSession().getLocale(), "images.managementtool.buttons.deleteRepository"), "tool.managementtool.deleteRepository.header"));
